  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 bg-card-gradient px-4 py-4 text-white transition-all duration-300 group-hover:h-3/5 group-hover:pb-6">
          <div className="space-y-2">
            ...
            <div className="hidden items-center justify-between gap-3 group-hover:flex">
              <span className="inline-flex items-center gap-1 rounded-full bg-cinema-red px-3 py-2 text-xs font-semibold text-white">
                ⭐ {movie.imdbRating ?? 'N/A'}
              </span>
              <span className="rounded-full border border-white/10 bg-black/40 px-3 py-2 text-xs text-cinema-white">
                View Details
              </span>
            </div>
          </div>
      ...
      <button
        ...
        className="absolute right-4 top-4 z-10 inline-flex h-11 w-11 items-center justify-center rounded-full bg-black/60 text-white transition hover:bg-cinema-red"
      ...
      {showRemove && onRemove && (
        <button
          ...
          className="absolute bottom-4 right-4 inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-2 text-xs text-cinema-white transition hover:bg-cinema-red"
