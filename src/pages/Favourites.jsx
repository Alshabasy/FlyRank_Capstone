    ...
    <ProtectedRoute>
      <main className="min-h-screen bg-cinema-black text-cinema-white px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl space-y-10">
          <div className="rounded-3xl border border-theme bg-cinema-dark/95 p-8 shadow-cinema">
          ...
          {loading ? (
            ...
            <div className="rounded-3xl border border-theme bg-cinema-dark/90 p-10 text-center">
              <div className="mx-auto flex max-w-xl flex-col items-center gap-4">
                <div className="h-40 w-40 rounded-3xl bg-glass" aria-hidden="true" />
                <p className="text-lg font-semibold text-cinema-white">No movies saved yet.</p>
                <p className="text-sm text-cinema-muted">Start exploring and add movies to your watchlist.</p>
                <Link
                  to="/"
                  className="rounded-2xl bg-cinema-red px-6 py-3 text-sm font-semibold text-cinema-white transition hover:bg-cinema-red-2"
                >
                  Start exploring →
                </Link>
              </div>
